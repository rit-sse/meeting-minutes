...
### Mentoring
	- Will reach out to people we want as mentors, if that doesn伍西t work a second call will be sent out
...
### Projects
	...
	- Marissa might do some work for the sse伍西s mobile page
	...
	-Rapdev is planned to run in a similar way to last year
		- Morgan will start questioning last year伍西s intersession rapdev team for advice
### General Extra
...
### Treasury
	...
	- September伍西s budget report is due by next officer meeting
